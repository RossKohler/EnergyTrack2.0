...
<p>1.	${winnerFloor}, ${winnerFloorChange}% ${winnerMoreOrLess}</p>
<p>2.	${secondFloor},  ${secondFloorChange}% ${secondMoreOrLess}</p>
<p>3.	${thirdFloor}, ${thirdFloorChange}% ${thirdMoreOrLess}</p>
